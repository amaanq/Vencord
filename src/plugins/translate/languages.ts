...
// Kagi uses lowercase ISO-639 language codes, similar to Google
// but in lowercase format (e.g., "en" instead of "EN")
...
export function kagiLanguageToGoogleLanguage(language: string) {
    // Kagi and Google use similar codes, but some differ
    switch (language) {
        case "zh": return "zh-CN";
        case "he": return "iw"; // Google uses "iw" for Hebrew
        case "jv": return "jw"; // Google uses "jw" for Javanese
        default:
            return language;
    }
}
